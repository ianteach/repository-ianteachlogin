...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        // untuk mengatur Rule: Name,Email
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'IT User Registration';
            $this->load->view('templates/auth_header', $data);
    ...
    // method untuk Send Verify password ke email
    private function _sendEmail($token, $type)
    {
        $config = [
            'protocol' => 'smtp',
            'smtp_host' => 'ssl://smtp.googlemail.com',
            'smtp_user' => 'ianteachlogin@gmail.com',
            'smtp_pass' => 'ianteachlogin12345',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('ianteachlogin@gmail.com', 'ianteach Networking');
    ...
    // method fucntion verify = function ini berfungsi terhadap file yang akan di kirim kan ke link activate di email
    ...
    // akhir form validation forgot password
